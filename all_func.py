...
##################################################################################################################
#    PREPARATION DE LA BASE DE DONNEES POUR LE LLM SUR LES OFFRES D EMPLOI SCRAPPEES
##################################################################################################################

# installation à faire avant de lancer la fonction :
...
def prepa_chatbot():
    ...
    data = pd.read_csv(chemin+'jobs_final.csv')
